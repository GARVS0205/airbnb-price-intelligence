  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ background: "var(--surface)", borderBottom: "1px solid var(--ghost-border)" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "48px 32px 44px", textAlign: "center" }}>
      ...
      <main style={{ flex: 1, background: "var(--bg)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 32px 80px", display: "flex", flexDirection: "column", gap: 48 }}>
